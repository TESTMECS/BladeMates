export const tags: {
    ...
    "Cars": ["cars", "automobiles", "electric vehicles"],
    "Elon Musk": ["elon musk", "tesla", "spacex"],
    // istfg this dude needs to stay out of the news
    "Facebook": ["facebook", "meta"],
    "Cellular Networks": ["5g", "cellular networks"],
    "Crypto": ["crypto", "cryptocurrency", "bitcoin", "ethereum", "btc", "eth", "dogecoin"],
    "Streaming": ["streaming", "netflix", "hulu", "disney+"],
